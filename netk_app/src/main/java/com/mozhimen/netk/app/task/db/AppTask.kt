...
//        !apkIsInstalled && CNetKAppTaskState.isTaskWait(taskState)
    ...
    override fun toString(): String {
        return "AppTask(taskId='$taskId', taskState=$taskState, downloadProgress=$downloadProgress, downloadFileSize=$downloadFileSize, apkFileSize=$apkFileSize, apkFileMd5='$apkFileMd5', apkPackageName='$apkPackageName', apkName='$apkName', apkVersionCode=$apkVersionCode, apkVersionName='$apkVersionName', apkIconUrl='$apkIconUrl', apkIconId=$apkIconId, apkFileName='$apkFileName', apkPathName='$apkPathName', apkIsInstalled=$apkIsInstalled, apkVerifyNeed=$apkVerifyNeed, apkUnzipNeed=$apkUnzipNeed, taskUpdateTime=$taskUpdateTime, downloadId=$downloadId, downloadUrlOutSide='$downloadUrlOutSide', downloadUrlCurrent='$downloadUrlCurrent')"
    }
}