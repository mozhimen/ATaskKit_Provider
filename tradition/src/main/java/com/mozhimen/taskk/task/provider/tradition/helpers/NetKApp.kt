...
//import com.mozhimen.taskk.task.provider.tradition.impls.unzip.NetKAppUnzipManager
//import com.mozhimen.taskk.task.provider.tradition.impls.download.NetKAppDownloadManager
//import com.mozhimen.taskk.provider.download.impls.intErrorCode2taskException
//import com.mozhimen.taskk.task.provider.tradition.impls.install.NetKAppInstallManager
//import com.mozhimen.taskk.task.provider.tradition.impls.install.NetKAppInstallProxy
//import com.mozhimen.taskk.task.provider.tradition.impls.uninstall.NetKAppUnInstallManager
...
//    private val _netKAppInstallProxy by lazy { com.mozhimen.taskk.task.provider.tradition.impls.install.NetKAppInstallProxy(_context, ProcessLifecycleOwner.get()) }
//
...
//            com.mozhimen.taskk.task.provider.tradition.impls.install.NetKAppInstallManager.init()
...
//                        com.mozhimen.taskk.task.provider.tradition.impls.install.NetKAppInstallManager.onInstallSuccess(packageInfo.packageName, UtilKPackageInfo.getVersionCode(packageInfo))
//                    }
//
//                    override fun onPackageRemove(packageInfo: PackageInfo) {
//                        com.mozhimen.taskk.task.provider.tradition.impls.uninstall.NetKAppUnInstallManager.onUninstallSuccess(packageInfo.packageName)
//                    }
//                })
//            }
//            com.mozhimen.taskk.task.provider.tradition.impls.unzip.NetKAppUnzipManager.init(strSourceApkNameUnzip)
//            com.mozhimen.taskk.task.provider.tradition.impls.download.NetKAppDownloadManager.init(context, compare)
...
//                                                }
//                                                .show()*/
//                        throw CErrorCode.CODE_TASK_NEED_MEMORY_NPK.intErrorCode2taskException()
//                    }
//                }
//            }
...
//
//            com.mozhimen.taskk.task.provider.tradition.impls.download.NetKAppDownloadManager.download(appTask/*, listener*/)
...
//            com.mozhimen.taskk.task.provider.tradition.impls.download.NetKAppDownloadManager.downloadCancel(appTask/*, onCancelBlock*/)//从数据库中移除掉
//        } else if (appTask.atTaskUnzip() && appTask.isTaskUnzipSuccess()) {
//            UtilKLogWrapper.d(TAG, "taskCancel: installCancel")
//            com.mozhimen.taskk.task.provider.tradition.impls.install.NetKAppInstallManager.installCancel(appTask)
//        } else if (appTask.atTaskUnzip() && com.mozhimen.taskk.task.provider.tradition.impls.unzip.NetKAppUnzipManager.isUnziping(appTask)) {
...
//            com.mozhimen.taskk.task.provider.tradition.impls.download.NetKAppDownloadManager.downloadPause(appTask)
//        }
//    }
//
...
//            com.mozhimen.taskk.task.provider.tradition.impls.download.NetKAppDownloadManager.downloadResume(appTask)
//        }
//    }
//
//    @OptIn(OPermission_REQUEST_INSTALL_PACKAGES::class)
...
//            com.mozhimen.taskk.task.provider.tradition.impls.unzip.NetKAppUnzipManager.unzip(appTask)
//        }
//    }
//
...
//
//    fun onDestroy() {
//        com.mozhimen.taskk.task.provider.tradition.impls.download.NetKAppDownloadManager.downloadPauseAll()
//    }
//    //endregion
//
//    /////////////////////////////////////////////////////////////////
...
//        return com.mozhimen.taskk.task.provider.tradition.impls.download.NetKAppDownloadManager.getAppDownloadProgress(appTask)?.isDownloading() ?: false//查询下载状态
//    }
//
...
//                 * [CNetKAppState.STATE_DOWNLOAD_FAIL]
//                 */
//                onDownloadFail(appTask, CErrorCode.CODE_DOWNLOAD_SERVER_CANCELED.intErrorCode2taskException(exception.message ?: ""))
//            }
//        } else {
//            /**
//             * [CNetKAppState.STATE_DOWNLOAD_FAIL]
//             */
//            onDownloadFail(appTask, CErrorCode.CODE_DOWNLOAD_SERVER_CANCELED.intErrorCode2taskException())
//        }
//    }
//
