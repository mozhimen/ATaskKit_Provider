package com.mozhimen.taskk.task.provider.tradition
...
import com.mozhimen.taskk.task.provider.cons.CTaskEvent
...
import com.mozhimen.taskk.task.provider.tradition.commons.ITaskState
...
//        NetKOkDownloadExt.init(context)
            ...
            InstallKManager.apply {
                ...
                registerPackagesChangeListener(object : IPackagesChangeListener {
                    override fun onPackageAdd(packageName: String, versionCode: Int) {
