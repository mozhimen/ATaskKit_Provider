package com.mozhimen.taskk.provider.task.open
...
class TaskSetOpen(taskManager: ATaskManagerProvider, override val providerDefaults: List<ATaskOpen>) : ATaskSetOpen(taskManager) {
