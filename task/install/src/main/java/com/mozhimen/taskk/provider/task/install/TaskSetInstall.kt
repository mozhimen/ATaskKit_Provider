package com.mozhimen.taskk.provider.task.install
...
open class TaskSetInstall(taskManager: ATaskManagerProvider, override val providerDefaults: List<ATaskInstall>) : ATaskSetInstall(taskManager) {
