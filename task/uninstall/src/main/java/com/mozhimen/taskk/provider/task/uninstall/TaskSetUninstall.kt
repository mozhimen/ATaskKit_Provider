package com.mozhimen.taskk.provider.task.uninstall
...
class TaskSetUninstall(taskManager: ATaskManagerProvider, override val providerDefaults: List<ATaskUninstall>) : ATaskSetUninstall(taskManager) {
