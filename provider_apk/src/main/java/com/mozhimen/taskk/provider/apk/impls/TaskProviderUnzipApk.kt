...
class TaskProviderUnzipApk(iTaskProviderLifecycle: ITaskProviderLifecycle?) : ATaskProviderUnzip(iTaskProviderLifecycle) {
    ...
    fun setTaskProviderInterceptor(iTaskProviderInterceptor: ITaskProviderInterceptorApk): TaskProviderUnzipApk {
    ...
    fun setTargetFile(targetFile: String): TaskProviderUnzipApk {
        _sniffTargetFile = targetFile
        return this
    }

    fun removeTargetFile(): TaskProviderUnzipApk {
        _sniffTargetFile = ""
        return this
    }

    fun setUnzipDir(unzipDir: File): TaskProviderUnzipApk {
        _unzipDir = unzipDir
        return this
    }
