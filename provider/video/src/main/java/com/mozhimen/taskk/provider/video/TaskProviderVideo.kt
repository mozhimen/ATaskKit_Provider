...
open class TaskProviderVideo constructor(
    ...
    override fun getTaskOpen(): ATaskOpen {
        return TaskOpenVideo(_taskManagerProvider,_iTaskLifecycle)
    }
    ...
    override fun getTaskDelete(): ATaskDelete? {
        return TaskDeleteVideo(_taskManagerProvider,_iTaskLifecycle)
    }
