...
interface INetKAppStateView<V> {
    ...
    fun onVerifyFail(view: V?, appTask: AppTask, exception: TaskException) {}//应用校验失败
    ...
    fun onUnzipFail(view: V?, appTask: AppTask, exception: TaskException) {}//解压失败
    ...
    fun onInstallFail(view: V?, appTask: AppTask, exception: TaskException) {}
