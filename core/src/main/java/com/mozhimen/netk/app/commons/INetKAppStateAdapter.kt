...
interface INetKAppStateAdapter<A : Adapter<ViewHolder>> {
    ...
    fun onDownloadFail(adapter: A?, position: Int, appTask: AppTask, exception: com.mozhimen.taskk.provider.download.impls.AppDownloadException) {}//下载失败的回调
    ...
    fun onVerifyFail(adapter: A?, position: Int, appTask: AppTask, exception: com.mozhimen.taskk.provider.download.impls.AppDownloadException) {}//应用校验失败
    ...
    fun onUnzipFail(adapter: A?, position: Int, appTask: AppTask, exception: com.mozhimen.taskk.provider.download.impls.AppDownloadException) {}//解压失败
    ...
    fun onInstallFail(adapter: A?, position: Int, appTask: AppTask, exception: com.mozhimen.taskk.provider.download.impls.AppDownloadException) {}
