...
//    const val STATE_DOWNLOAD_WAIT = STATE_DOWNLOAD_CREATE + CNetKAppTaskState.STATE_TASK_WAIT//11//下载等待
    ...
    const val STATE_INSTALLING = STATE_INSTALL_CREATE + CState.STATE_TASKING//40//STATE_INSTALLING = 1//安装中
    ...
    const val STATE_INSTALL_CANCEL = STATE_INSTALL_CREATE + CState.STATE_TASK_CANCEL//49//STATE_INSTALLED = 2//安装取消
