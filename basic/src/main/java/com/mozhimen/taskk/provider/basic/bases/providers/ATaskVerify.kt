 ...
 * @Version 1.0
 */
abstract class ATaskVerify(taskManager: ATaskManagerProvider, iTaskLifecycle: ITaskLifecycle?) : ATask(taskManager,iTaskLifecycle) {
    ...
    override fun taskStart(appTask: AppTask, @ATaskNodeQueueName taskNodeQueueName: String) {
        onTaskStarted(ATaskState.STATE_VERIFYING, appTask, taskNodeQueueName)
    }
